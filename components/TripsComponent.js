  ...
  const fetchTrips = async () => {
    if (db !== undefined) {
      ...
      await Promise.all(foundTrips.map(async (trip) => {
        ...
        const newTrip = { resortName: trip.resort_name, viewTypeName: trip.view_type_name, roomTypeName: trip.room_type_name, checkInDate: trip.check_in_date, checkOutDate: trip.check_out_date, points: trip.points, contract: contractStr }
